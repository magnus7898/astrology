...
Sub-pages served:
/                  - landing page (index.html if present, else built-in hub)
...
/static/…        - serves the merged human_prepared.svg and assets
“””
...
return jsonify({
    ...
    'asc':      round(asc, 4),
    'mc':       round(mc, 4),
    'asc_sign': trop_sign(asc),
    'mc_sign':  trop_sign(mc),
...
‘nakshatra’:      n[‘name’],
‘nakshatra_ka’:   n[‘ka’],
‘nakshatra_ruler’: n[‘ruler’],
‘deity’:          n[‘deity’],
‘symbol’:         n[‘symbol’],
‘pada’:           pada,
‘pada_sign’:      PADA_SIGNS[psi],
‘pada_ruler’:     PADA_RULERS[psi],
‘nak_idx’:        ni,
‘nak_pos’:        round(np2, 4),
‘pct’:            round(np2 / sz * 100, 1),
}
...
‘asc’:          round(asc_sid, 4),
‘mc’:           round(mc_sid, 4),
‘asc_sign’:     ved_sign(asc_sid),
‘asc_sign_idx’: lagna_si,
‘mc_sign’:      ved_sign(mc_sid),
...
‘sym’:              con[‘sym’],
‘pos_in_con’:       round(pic, 4),
‘dms’:              true_sid_fmtDMS(con, pic),
‘span’:             round(span, 1),
‘pct’:              round(pic / span * 100, 1),
‘retrograde’:       pos[3] < 0,
}
...
trop2    = (trop + 180) % 360
con2, pic2 = get_true_constellation(trop2)
span2    = (con2[‘end’] - con2[‘start’]) % 360 or 360
planets[‘South Node’] = {
‘tropical’: round(trop2, 4), ‘constellation’: con2[‘name’],
‘constellation_ka’: con2[‘ka’], ‘sym’: con2[‘sym’],
‘pos_in_con’: round(pic2, 4), ‘dms’: true_sid_fmtDMS(con2, pic2),
‘span’: round(span2, 1), ‘pct’: round(pic2 / span2 * 100, 1),
‘retrograde’: True,
}
except Exception:
pass
...
try:
vx = float(ascmc[3])
con, pic = get_true_constellation(vx)
span = (con[‘end’] - con[‘start’]) % 360 or 360
planets[‘Vertex’] = {
‘tropical’: round(vx, 4), ‘constellation’: con[‘name’],
‘constellation_ka’: con[‘ka’], ‘sym’: con[‘sym’],
‘pos_in_con’: round(pic, 4), ‘dms’: true_sid_fmtDMS(con, pic),
‘span’: round(span, 1), ‘pct’: round(pic / span * 100, 1),
...
span = (con[‘end’] - con[‘start’]) % 360 or 360
planets[‘Fortune’] = {
‘tropical’: round(f, 4), ‘constellation’: con[‘name’],
‘constellation_ka’: con[‘ka’], ‘sym’: con[‘sym’],
‘pos_in_con’: round(pic, 4), ‘dms’: true_sid_fmtDMS(con, pic),
‘span’: round(span, 1), ‘pct’: round(pic / span * 100, 1),
...
On 21 Apr 2026, at 17:38, alexandrus magnus <alexandrusmagnus@outlook.com> wrote:
