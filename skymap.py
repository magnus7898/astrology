# -*- coding: utf-8 -*-
"""
skymap.py — true astronomical sky placement (JPL/Swiss Ephemeris precision).

For each body: apparent RA/Dec, ecliptic lon/lat, the actual IAU
constellation (official Roman 1987 boundary table, all 88 — planets
really do pass through ~25 constellations incl. Ophiuchus, Cetus,
Orion, Sextans), and conjunctions with major fixed stars (sefstars.txt).
"""
...
BODIES = {"sun": swe.SUN, "moon": swe.MOON, "mercury": swe.MERCURY,
          ...
          "chiron": swe.CHIRON}
BODY_KA = {"sun": "მზე", "moon": "მთვარე", "mercury": "მერკური",
           "venus": "ვენერა", "mars": "მარსი", "jupiter": "იუპიტერი",
           "saturn": "სატურნი", "uranus": "ურანი", "neptune": "ნეპტუნი",
           "pluto": "პლუტონი", "chiron": "ქირონი"}

# major fixed stars (sefstars.txt names) with Georgian labels
STARS = [("Aldebaran", "ალდებარანი"), ("Regulus", "რეგული"),
         ("Spica", "სპიკა"), ("Antares", "ანტარესი"),
         ("Algol", "ალგოლი"), ("Sirius", "სირიუსი"),
         ("Vega", "ვეგა"), ("Pollux", "პოლუქსი"),
         ("Castor", "კასტორი"), ("Procyon", "პროციონი"),
         ("Betelgeuse", "ბეტელგეიზე"), ("Rigel", "რიგელი"),
         ("Altair", "ალტაირი"), ("Fomalhaut", "ფომალჰაუტი"),
         ("Deneb", "დენები"), ("Arcturus", "არქტური"),
         ("Capella", "კაპელა"), ("Alcyone", "ალციონე (პლეადები)"),
         ("Achernar", "აქერნარი"), ("Canopus", "კანოპუსი"),
         ("Alphard", "ალფარდი"), ("Denebola", "დენებოლა"),
         ("Algieba", "ალგიება"), ("Zuben Elgenubi", "ზუბენ ელგენუბი"),
         ("Zuben Eschamali", "ზუბენ ეშამალი"), ("Rasalhague", "რას ალჰაგე"),
         ("Galactic Center", "გალაქტიკის ცენტრი"),
         ("Bellatrix", "ბელატრიქსი"), ("Alnilam", "ალნილამი"),
         ("Mirach", "მირახი"), ("Hamal", "ჰამალი"),
         ("Scheat", "შეატი"), ("Markab", "მარკაბი"),
         ("Sadalmelek", "სადალმელიქი"), ("Alphecca", "ალფეკა"),
         ("Wega", None)]
STAR_ORB = 2.0

CONST_KA = {'And': 'ანდრომედა', 'Ant': 'ტუმბო', 'Aps': 'სამოთხის ჩიტი', 'Aqr': 'მერწყული', 'Aql': 'არწივი', 'Ara': 'სამსხვერპლო', 'Ari': 'ვერძი', 'Aur': 'მეეტლე', 'Boo': 'მენახირე', 'Cae': 'საჭრეთელი', 'Cam': 'ჟირაფი', 'Cnc': 'კირჩხიბი', 'CVn': 'მონადირე ძაღლები', 'CMa': 'დიდი ძაღლი', 'CMi': 'მცირე ძაღლი', 'Cap': 'თხის რქა', 'Car': 'კილი', 'Cas': 'კასიოპეა', 'Cen': 'კენტავრი', 'Cep': 'ცეფეოსი', 'Cet': 'ვეშაპი', 'Cha': 'ქამელეონი', 'Cir': 'ფარგალი', 'Col': 'მტრედი', 'Com': 'ბერენიკეს თმა', 'CrA': 'სამხრეთის გვირგვინი', 'CrB': 'ჩრდილოეთის გვირგვინი', 'Crv': 'ყორანი', 'Crt': 'თასი', 'Cru': 'სამხრეთის ჯვარი', 'Cyg': 'გედი', 'Del': 'დელფინი', 'Dor': 'ოქროს თევზი', 'Dra': 'დრაკონი', 'Equ': 'პატარა ცხენი', 'Eri': 'ერიდანი', 'For': 'ღუმელი', 'Gem': 'ტყუპები', 'Gru': 'წერო', 'Her': 'ჰერკულესი', 'Hor': 'საათი', 'Hya': 'ჰიდრა', 'Hyi': 'სამხრეთის ჰიდრა', 'Ind': 'ინდიელი', 'Lac': 'ხვლიკი', 'Leo': 'ლომი', 'LMi': 'მცირე ლომი', 'Lep': 'კურდღელი', 'Lib': 'სასწორი', 'Lup': 'მგელი', 'Lyn': 'ფოცხვერი', 'Lyr': 'ლირა', 'Men': 'მაგიდის მთა', 'Mic': 'მიკროსკოპი', 'Mon': 'მარტორქა', 'Mus': 'ბუზი', 'Nor': 'გონიო', 'Oct': 'ოქტანტი', 'Oph': 'გველისმჭერი', 'Ori': 'ორიონი', 'Pav': 'ფარშევანგი', 'Peg': 'პეგასი', 'Per': 'პერსევსი', 'Phe': 'ფენიქსი', 'Pic': 'მხატვარი', 'Psc': 'თევზები', 'PsA': 'სამხრეთის თევზი', 'Pup': 'კიჩო', 'Pyx': 'კომპასი', 'Ret': 'ბადე', 'Sge': 'ისარი', 'Sgr': 'მშვილდოსანი', 'Sco': 'მორიელი', 'Scl': 'მოქანდაკე', 'Sct': 'ფარი', 'Ser': 'გველი', 'Sex': 'სექსტანტი', 'Tau': 'კურო', 'Tel': 'ტელესკოპი', 'Tri': 'სამკუთხედი', 'TrA': 'სამხრეთის სამკუთხედი', 'Tuc': 'ტუკანი', 'UMa': 'დიდი დათვი', 'UMi': 'მცირე დათვი', 'Vel': 'იალქანი', 'Vir': 'ქალწული', 'Vol': 'მფრინავი თევზი', 'Vul': 'მელა'}
...
# J2000 -> B1875 precession rotation matrix (IAU76)
PREC_M = [[0.999535872942, 0.027936937767, 0.012147683341], [-0.02793693821, 0.999609673167, -0.000169687453], [-0.012147682322, -0.000169760382, 0.999926199775]]

# Roman 1987 IAU boundary table: (ra_low_h, ra_high_h, dec_low_deg, abbr) at B1875
BOUNDS = [
    (0.0, 24.0, 88.0, 'UMi'),
    (8.0, 14.5, 86.5, 'UMi'),
...
def _j2000_to_b1875(ra_deg, dec_deg):
    ...
    ra2 = math.degrees(math.atan2(y2, x2)) % 360.0
    de2 = math.degrees(math.asin(max(-1.0, min(1.0, z2))))
    return ra2, de2


def constellation(ra_j2000_deg, dec_j2000_deg):
    """IAU constellation from J2000 equatorial coords (Roman 1987)."""
    ra, de = _j2000_to_b1875(ra_j2000_deg, dec_j2000_deg)
    rah = ra / 15.0
    for ra_lo, ra_hi, de_lo, ab in BOUNDS:
        if de >= de_lo and ra_lo <= rah < ra_hi:
            return ab
    return "UMi"
...
def _fmt_dec(d):
    s = "+" if d >= 0 else "−"
    a = abs(d); dd = int(a); mm = int((a - dd) * 60)
    return f"{s}{dd:02d}° {mm:02d}′"


def compute_skymap(jd, star_orb=STAR_ORB):
    """True-sky placement for all bodies + fixed-star conjunctions."""
    # fixed star ecliptic longitudes (once)
    stars = []
    for nm, ka in STARS:
        if ka is None:
            continue
        try:
            xx, _, _ = swe.fixstar2_ut(nm, jd, 0)
            stars.append((nm, ka, xx[0]))
        except Exception:
            pass
    ...
    for k, pid in BODIES.items():
        try:
            ecl = swe.calc_ut(jd, pid)[0]
            eq = swe.calc_ut(jd, pid, swe.FLG_EQUATORIAL)[0]
            eq2000 = swe.calc_ut(jd, pid,
                                 swe.FLG_EQUATORIAL | swe.FLG_J2000
                                 | swe.FLG_NONUT)[0]
        except Exception:
            continue
        ab = constellation(eq2000[0], eq2000[1])
        conj = []
        for nm, ka, slon in stars:
            d = abs((ecl[0] - slon + 180.0) % 360.0 - 180.0)
            if d <= star_orb:
                conj.append({"star": nm, "star_ka": ka,
                             "orb": round(d, 2)})
        conj.sort(key=lambda c: c["orb"])
        out.append({
            "key": k, "name_ka": BODY_KA[k],
            "ra": _fmt_ra(eq[0]), "dec": _fmt_dec(eq[1]),
            "ra_deg": round(eq[0], 4), "dec_deg": round(eq[1], 4),
            "ecl_lon": round(ecl[0], 4), "ecl_lat": round(ecl[1], 4),
            "distance_au": round(ecl[2], 6),
            "constellation": ab,
            "constellation_name": CONST_NAME.get(ab, ab),
            "constellation_ka": CONST_KA.get(ab, CONST_NAME.get(ab, ab)),
            "retrograde": len(ecl) > 3 and ecl[3] < 0,
            "stars": conj,
        })
    return {"bodies": out}
